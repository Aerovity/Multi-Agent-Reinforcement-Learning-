...
def load_config(config_path: str = "config_marl.yaml") -> dict:
...
def create_agents_from_config(config: dict) -> List[Agent]:
...
def print_config_summary(config: dict, agents: List[Agent]) -> None:
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Orchestry MARL - Train LLM agents to collaborate"
    )
    ...
    parser.add_argument(
        '--config',
        type=str,
        default='config_marl.yaml',
        help='Path to config file (default: config_marl.yaml)'
    )
    ...
    parser.add_argument(
        '--show-best',
        action='store_true',
        help='Show best episode at the end'
    )
