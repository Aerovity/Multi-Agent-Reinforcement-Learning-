...
class BehaviorLibrary:
    ...
    def extract_successful_behaviors(
        ...
        logger.info(
            f"Analyzing top {num_top} episodes (out of {len(episodes)}) "
            f"for behavior extraction"
        )
        ...
        try:
            ...
            behaviors = self._parse_behavior_response(
    ...
    def _build_analysis_prompt(
        ...
        prompt = f"""You are analyzing successful multi-agent {task_type} episodes to extract behavioral patterns.
...
Return ONLY the JSON object, no other text."""
    ...
    def _parse_behavior_response(
        ...
        try:
            ...
            behaviors = json.loads(json_text)
